      ...
      <div className='slideshow-container'>
        ...
        <div className={`mySlides fade ${slideIndex === 1 ? 'active' : ''}`}>
          <div className="searchItem">
              <img src='assets/Billeder/Vandrerhjem/vaerelse2.jpg' className='w-52' alt='Slide 1' />
              <div className="sDesc">
        ...
        <div className={`mySlides fade ${slideIndex === 2 ? 'active' : ''}`}>
          <div className="searchItem">
            <img src='assets/Billeder/Vandrerhjem/vaerelse1.jpg' className='w-52' alt='Slide 1' />
            <div className="sDesc">
              <h1 className="sTitle">Tower Street Apartment</h1>
              <span className='sDistance'>500m from center</span>
              <span className='sTaxi'>Free Airport Taxi</span>
