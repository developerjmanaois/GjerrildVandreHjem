...
const Skandinavisk = () => {
  ...
  useEffect(() => {
    makeRequest("https://api.airtable.com/v0/appdVuqpV8gkE6Oz1/skandinavisk?sort[0][field]=Id", 
  ...
  useEffect(() => {
    activityMakeRequest("https://api.airtable.com/v0/appdVuqpV8gkE6Oz1/aktiviteter?filterByFormula=Id=4", 
  ...
  return (
    ...
    <div>
      ...
      <article className="max-w-5xl mx-auto my-14 p-5 bg-white shadow-lg rounded-lg">
        ...
        <h1 className='mb-6 text-4xl font-bold text-center text-gray-800'>Skandinavisk Dyrepark</h1>
        ...
        <img className="w-full h-100 object-cover rounded-lg" src={activityData.records[0].fields.image[0].url} alt="bear_image" />
        }
